      ...
      <div class="main-div m-12 pb-2">
        ...
        >
          ...
          <div class="flex items-center">
            <div class="me-2 font-medium">Manage Repositories</div>
            <div
              style="cursor: pointer"
              class="font-bold bg-primary circle text-white px-1 relative"
            >
              +
              <!-- Manage repositories Plus Button -->
              <div
                class="flex-col justify-start absolute right-0 bg-gray-50 shadow-2xl text-black rounded-md py-2 border mt-2"
              >
                <div
                  class="hover:bg-slate-200 w-full px-4 pe-8 rounded-md my-2"
                >
                  Github
                </div>
                <div
          ...
          <table>
            ...
            <tbody>
              <tr class="font-medium" v-for="(row, index) in data" :key="index">
                ...
                <td>
                  <div class="flex items-center">
                    <div class="priority-one px-[28px] z-40"></div>
                    <div class="priority-two px-[16px] -ms-2 z-30"></div>
                    <div
                      class="ms-4"
                ...
                <td>
                  <button class="flex items-center">
                    <div
                      class="tags-btn z-40 px-[10px]"
                      v-for="tag in row.tags.split(',')"
                    >
                      {{ tag }}
                    </div>
                    <div class="tags-plus px-[12px] -ms-4 z-30">
